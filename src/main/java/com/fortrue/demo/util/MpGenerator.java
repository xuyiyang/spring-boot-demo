...
//        assert (false) : "代码生成属于危险操作，请确定配置后取消断言执行代码生成！";
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mydb?serverTimezone=GMT%2B8&characterEncoding=utf8&allowMultiQueries=true&useSSL=false");
        mpg.setDataSource(dsc);

        // 策略配置
        StrategyConfig strategy = new StrategyConfig();
        // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
//        strategy.setTablePrefix(new String[] { "my_" });// 此处可以修改为您的表前缀
        ...
        pc.setParent("com.fortrue.demo.mapper");
